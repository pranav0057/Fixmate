          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
              {features.map((feature, index) => (
                ...
                >
                  <div
                    className={`mb-6 group-hover:scale-110 transition-transform duration-300 ${feature.title === "Boost Personal Growth"
                        ? "text-purple-400"
                        : "text-teal-400"
                      }`}
                  >
                  ...
                  <h3
                    className={`text-xl font-bold mb-4 ${feature.title === "Boost Personal Growth"
                        ? "text-purple-300"
                        : "text-white"
                      }`}
                  >
